...
class Fragment_s_draconami : Fragment() {
    ...
    private val DraconList = listOf(
        ...
        Dracony("Американський психопат", R.drawable.whisper, "Це один із найжахливіших, найнебезпечніших драконів," +
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val binding = FragmentBlankSDraconamiBinding.bind(view)
        binding.apply{
